...
(() => {
  ...
  var e = {
      ...
      448: (e, t, n) => {
              ...
              b &&
                (An &&
                  ...
                  (Vn || 'onCompositionStart' !== b
                    ...
                    : ((en = 'value' in (Zt = a) ? Zt.value : Zt.textContent), (Vn = !0))),
                0 < (v = Rr(r, b)).length &&
        ...
        function So(e) {
          ...
          function s(e, t, n, r) {
            return null !== t && t.elementType === n.type
              ...
              : (((r = Vu(n.type, n.key, n.props, null, e.mode, r)).ref = xo(e, t, n)),
                (r.return = e),
                r);
          }
          function c(e, t, n, r) {
          ...
          function d(e, t, n) {
            ...
            if ('object' == typeof t && null !== t) {
              switch (t.$$typeof) {
                case j:
                  return (
                    ((n = Vu(t.type, t.key, t.props, null, e.mode, n)).ref = xo(e, null, t)),
                    (n.return = e),
                    n
                  );
                case x:
              ...
              if (jo(t) || q(t)) return ((t = $u(t, e.mode, n, null)).return = e), t;
              Eo(e, t);
            }
            return null;
          }
          function p(e, t, n, r) {
            ...
            if ('object' == typeof n && null !== n) {
              ...
              if (jo(n) || q(n)) return null !== a ? null : f(e, t, n, r, null);
              Eo(e, n);
            }
            return null;
          }
          function m(e, t, n, r, a) {
            ...
            if ('object' == typeof r && null !== r) {
              ...
              if (jo(r) || q(r)) return f(t, (e = e.get(n) || null), r, a, null);
              Eo(t, r);
            }
            return null;
          }
                ...
                case j:
                  e: {
                    ...
                    o.type === E
                      ...
                      : (((u = Vu(o.type, o.key, o.props, null, e.mode, u)).ref = xo(e, r, o)),
                        (u.return = e),
                        (e = u));
                  }
                  return i(e);
        ...
        function il() {
          ...
          return null === tl ? (Zo.memoizedState = tl = e) : (tl = tl.next = e), tl;
        }
        function ul() {
          if (null === el) {
            var e = Zo.alternate;
          ...
          if (null !== a) {
            ...
            do {
              ...
              if ((Jo & c) === c)
                ...
                null === u ? ((i = u = f), (o = r)) : (u = u.next = f), (Zo.lanes |= c), (Di |= c);
              }
              s = s.next;
            } while (null !== s && s !== a);
            null === u ? (o = r) : (u.next = i),
        ...
        function gl(e, t, n, r) {
          return (
            ...
            null === (t = Zo.updateQueue)
              ? ((t = { lastEffect: null }), (Zo.updateQueue = t), (t.lastEffect = e.next = e))
              : null === (n = t.lastEffect)
        ...
        function bl(e, t, n, r) {
          var a = il();
          (Zo.flags |= e), (a.memoizedState = gl(1 | t, n, void 0, void 0 === r ? null : r));
        }
        function wl(e, t, n, r) {
          var a = ul();
          r = void 0 === r ? null : r;
          ...
          (Zo.flags |= e), (a.memoizedState = gl(1 | t, n, o, r));
        }
        function kl(e, t) {
          return bl(516, 4, e, t);
        }
        ...
        function Nu(e, t) {
          ...
          if (
                ...
                for (i = e; null !== Hi; ) {
                  ...
                  switch (1038 & b) {
                    case 2:
                      ...
                      break;
                    case 6:
                      bi(Hi), (Hi.flags &= -3), xi(Hi.alternate, Hi);
                      break;
                    case 1024:
                      Hi.flags &= -1025;
                      break;
                    case 1028:
                      (Hi.flags &= -1025), xi(Hi.alternate, Hi);
                      break;
                    case 4:
                      xi(Hi.alternate, Hi);
                      break;
              ...
              null !== i &&
                ...
                'selectionStart' in b
                  ...
                  : (k = ((w = b.ownerDocument || document) && w.defaultView) || window)
                    ...
                    (j = Math.min(i.start, u)),
                    (i = void 0 === i.end ? j : Math.min(i.end, u)),
                    !k.extend && j > i && ((u = i), (i = j), (j = u)),
                    (u = pr(b, j)),
                    (o = pr(b, i)),
                    u &&
                      o &&
            ...
            do {
              try {
                for (b = e; null !== Hi; ) {
                  var x = Hi.flags;
                  if ((36 & x && mi(b, Hi.alternate, Hi), 128 & x)) {
                    w = void 0;
                    var E = Hi.ref;
                    if (null !== E) {
                      var S = Hi.stateNode;
          ...
          if (Gi) (Gi = !1), (Xi = e), (Ji = t);
            ...
            for (Hi = r; null !== Hi; )
              (t = Hi.nextEffect),
                (Hi.nextEffect = null),
                8 & Hi.flags && (((x = Hi).sibling = null), (x.stateNode = null)),
                (Hi = t);
          if (
            ...
            try {
              xa.onCommitFiberRoot(ja, n, void 0, 64 == (64 & n.current.flags));
            } catch (e) {}
        ...
        function Lu() {
          for (; null !== Hi; ) {
            ...
            uu ||
              ...
              (0 != (8 & Hi.flags)
                ? Ze(Hi, iu) && (uu = !0)
                : 13 === Hi.tag && Si(e, Hi) && Ze(Hi, iu) && (uu = !0));
            var t = Hi.flags;
            0 != (256 & t) && pi(e, Hi),
              0 == (512 & t) ||
                Gi ||
        ...
        function O(e) {
          for (var t = x(z); null !== t; ) {
            if (null === t.callback) E(z);
              ...
              E(z), (t.sortIndex = t.expirationTime), j(C, t);
            }
            t = x(z);
          }
        }
          ...
          try {
            for (
              ...
              if ('function' == typeof l) {
                ...
                (n = t.unstable_now()),
                  'function' == typeof i ? (_.callback = i) : _ === x(C) && E(C),
                  O(n);
              } else E(C);
              _ = x(C);
            }
          ...
          (t.unstable_scheduleCallback = function (e, o, l) {
            ...
            return (
              ...
              l > i
                ? ((e.sortIndex = l),
                  j(z, e),
                  null === x(C) && e === x(z) && (M ? a() : (M = !0), r(F, l - i)))
                : ((e.sortIndex = u), j(C, e), T || L || ((T = !0), n(R))),
              e
            );
          }),
  ...
  (n.n = (e) => {
    ...
    (() => {
      ...
      const R = ['onClick', 'reloadDocument', 'replace', 'state', 'target', 'to'],
        I = ['aria-current', 'caseSensitive', 'className', 'end', 'style', 'to', 'children'];
      function D(n) {
      ...
      const A = (0, t.forwardRef)(function (e, n) {
        ...
        V = function () {
          return t.createElement(
            'header',
            null,
            t.createElement(B, { url: '../img/LOGO.png' }),
        ...
        $ = function () {
          return t.createElement(
            'footer',
            null,
            t.createElement(B, { url: './img/LOGO-FOOTER.png' }),
        ...
        G = function () {
          return t.createElement(
            ...
            t.createElement(
              ...
              t.createElement(Y, {
                props: {
                  url: './img/kaBkci_8qcdvQ-unsplash.png',
        ...
        r.render(
          t.createElement(
            ...
            t.createElement(
              T,
              null,
              t.createElement(N, { path: '/', element: t.createElement(X, null) }),
              t.createElement(N, { path: 'apropos', element: t.createElement(G, null) }),
              t.createElement(N, { path: 'not-found', element: t.createElement(J, null) }),
              t.createElement(N, { path: '/*', element: t.createElement(J, null) })
            )
          ),
